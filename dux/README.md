...
**dux** (`@mszr/h3-dux`) is a DX/UX-first route kit inspired by [`h3-route-tools`](https://github.com/sandros94/h3-route-tools). It keeps h3 and Nitro exactly as they are, owns its route builder, Standard Schema validation, fetchdts-style client, Nitro codegen, and OpenAPI projection end-to-end, and asks one question: *what would feel most delightful to use?*

## Repo context

- This repository is a fork of [`sandros94/h3-route-tools`](https://github.com/sandros94/h3-route-tools), which remains reference context.
