...
/**
 * A `$fetch`-style typed fetch over a route `Source` — an `H3DuxApp` (`TypedFetch<typeof app>`) or
...
/**
 * Build a {@link TypedFetch} over a route `Source` (an `H3DuxApp` type or a code-generated routes
